...
Ce sont tous les deux des [bundlers](https://dev.to/sayanide/the-what-why-and-how-of-javascript-bundlers-4po9) JS. Ils permettent ainsi de regrouper un projet JS contenant plusieurs en un ensemble de fichiers réduit et plus optimisé. Webpack est sorti avant Vite.
Vite se démarque de Webpack par sa rapidité.
{{% /alert %}}
